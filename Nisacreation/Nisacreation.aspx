<%@ Page Language="C#" MasterPageFile="~/WebPage.master" AutoEventWireup="true" CodeBehind="Nisacreation.aspx.cs" Inherits="Nisacreation.Nisacreation" %>
         ...
         <table class="style5">
             ...
             <asp:Panel ID="Panel2" runat="server" Height="560px" Width="158px" ForeColor="#FFFFCC">
                 ...
                 <asp:HyperLink ID="HyperLink9" runat="server" 
                     NavigateUrl="~/lasieshandpurses.aspx" Target="_self" ForeColor="#FFFFCC">Ladies  Hand Purses</asp:HyperLink>
                 <br />
                 <br />
                 <br />
