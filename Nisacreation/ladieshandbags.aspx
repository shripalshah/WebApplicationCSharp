<%@ Page Language="C#" MasterPageFile="~/WebPage.master" AutoEventWireup="true" CodeBehind="ladieshandbags.aspx.cs" Inherits="Nisacreation.ladieshandbags" %>
             ...
             <asp:Panel ID="Panel2" runat="server" Height="560px" Width="158px" ForeColor="#FFFFCC">
                 ...
                 <td>
                     <asp:Panel ID="Panel7" runat="server" Height="560px" Width="842px" 
                         ...
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <asp:Image ID="Image10" runat="server" ImageUrl="images/lhb1.JPG" Height="151px" 
                             Width="174px"/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image1" runat="server" ImageUrl="images/lhb 2.JPG" Height="151px" 
                             Width="174px"/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image2" runat="server" ImageUrl="images/lhb3.JPG" Height="151px" 
                             Width="174px"/>
                             <br />
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <br />
                         <br />
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image3" runat="server" ImageUrl="images/lhb4.JPG" Height="151px" 
                             Width="174px"/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image4" runat="server" ImageUrl="images/lhb5.JPG" Height="151px" 
                             Width="174px"/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image5" runat="server" ImageUrl="images/lhb6.JPG" Height="151px" 
                             Width="174px"/>
                             &nbsp;&nbsp;&nbsp;
                         <br />
                         &nbsp;&nbsp;
                         ...
                         <br />
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image6" runat="server" ImageUrl="images/lhb7.JPG" Height="151px" 
                             Width="174px"/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image7" runat="server" ImageUrl="images/lhb8.JPG" Height="151px" 
                             Width="174px"/>
                     </asp:Panel>
                 </td>
             </tr>
