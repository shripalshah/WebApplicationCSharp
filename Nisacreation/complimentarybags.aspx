<%@ Page Language="C#" MasterPageFile="~/WebPage.master" AutoEventWireup="true" CodeBehind="complimentarybags.aspx.cs" Inherits="Nisacreation.complimentarybags" %>
             ...
             <asp:Panel ID="Panel2" runat="server" Height="560px" Width="158px" ForeColor="#FFFFCC">
                 ...
                 <td>
                     <asp:Panel ID="Panel7" runat="server" Height="560px" Width="842px" 
                         ...
                         &nbsp;&nbsp;
                        <asp:Image ID="Image10" runat="server" ImageUrl="images/cb1.JPG" Height="151px" 
                             Width="174px"/>

                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;

                             <asp:Image ID="Image1" runat="server" ImageUrl="images/cb2.JPG" Height="151px" 
                             Width="174px"/>
                       
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <asp:Image ID="Image2" runat="server" ImageUrl="images/cb3.JPG" Height="151px" 
                             Width="174px"/>
                         ...
                         <br />
                         &nbsp;&nbsp;
                       <asp:Image ID="Image3" runat="server" ImageUrl="images/cb4.JPG" Height="151px" 
                             Width="174px"/>
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <asp:Image ID="Image4" runat="server" ImageUrl="images/cb5.JPG" Height="151px" 
                             Width="174px"/>
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <asp:Image ID="Image5" runat="server" ImageUrl="images/cb6.JPG" Height="151px" 
                             Width="174px"/>
                         <br />
                         <br />
                         &nbsp;&nbsp;
                         <br />
                         &nbsp;&nbsp;
                         <asp:Image ID="Image6" runat="server" ImageUrl="images/cb7.JPG" Height="151px" 
                             Width="174px"/>
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                         <asp:Image ID="Image7" runat="server" ImageUrl="images/cb8.JPG" Height="151px" 
                             Width="174px"/>
                     </asp:Panel>
                 </td>
             </tr>
