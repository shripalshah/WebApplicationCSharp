<%@ Page Language="C#" MasterPageFile="~/WebPage.master" AutoEventWireup="true" CodeBehind="magazineholders.aspx.cs" Inherits="Nisacreation.magazineholders" %>
                     ...
                     <asp:Panel ID="Panel7" runat="server" Height="560px" Width="842px" 
                         style="margin-left: 0px; color: #FFFFCC">
                          ...
                          <asp:Image ID="Image3" runat="server" Height="151px" 
                              ImageUrl="images/mh1.JPG" Width="174px" />
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <asp:Image ID="Image1" runat="server" Height="151px" 
                              ImageUrl="images/mh2.JPG" Width="174px" />
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <asp:Image ID="Image2" runat="server" Height="151px" 
                              ImageUrl="images/mh3.JPG" Width="174px" />
                              <br />
                          <br />
                          <br />
                          <br />
                          ...
                          <br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <asp:Image ID="Image4" runat="server" Height="151px" 
                              ImageUrl="images/mh4.JPG" Width="174px" />
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <asp:Image ID="Image5" runat="server" Height="151px" 
                              ImageUrl="images/mh5.JPG" Width="174px" />
                     </asp:Panel>
                 </td>
             </tr>
         </table>
