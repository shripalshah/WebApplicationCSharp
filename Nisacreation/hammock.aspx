<%@ Page Language="C#" MasterPageFile="~/WebPage.master" AutoEventWireup="true" CodeBehind="hammock.aspx.cs" Inherits="Nisacreation.hammock" %>
             ...
             <asp:Panel ID="Panel2" runat="server" Height="560px" Width="158px" ForeColor="#FFFFCC">
                 ...
                 <td>
                     <asp:Panel ID="Panel7" runat="server" Height="560px" Width="842px" 
                         ...
                         <br />
                         <br />
                         <asp:Image ID="Image10" runat="server" ImageUrl="images/hammock1.JPG" Height="151px" 
                             Width="277px"/>
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                         <asp:Image ID="Image1" runat="server" ImageUrl="images/hammock2.JPG" Height="151px" 
                             Width="174px"/>
                         <br />
                         <br />
                         <br />
                         <br />
                         <asp:Image ID="Image2" runat="server" ImageUrl="images/hammock 3.JPG" Height="151px" 
                             Width="174px"/>
                     </asp:Panel>
                 </td>
             </tr>
