<%@ Page Language="C#" MasterPageFile="~/WebPage.master" AutoEventWireup="true" CodeBehind="ladieshandpurses.aspx.cs" Inherits="Nisacreation.ladieshandpurses" %>
             ...
             <asp:Panel ID="Panel2" runat="server" Height="560px" Width="158px" ForeColor="#FFFFCC">
                 ...
                 <td>
                     <asp:Panel ID="Panel7" runat="server" Height="560px" Width="842px" 
                         ...
                         <asp:Image ID="Image10" runat="server" ImageUrl="images/lhp1.JPG" Height="151px" 
                             Width="174px"/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image1" runat="server" ImageUrl="images/lhp2.JPG" Height="151px" 
                             Width="174px"/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image2" runat="server" ImageUrl="images/lhp3.JPG" Height="151px" 
                             Width="174px"/>
                             <br />
&nbsp;<br />
                         <br />
                         <br />
                         <asp:Image ID="Image3" runat="server" Height="151px" ImageUrl="images/lhp4.JPG" 
                             Width="174px" />
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image4" runat="server" ImageUrl="images/lhp5.JPG" Height="151px" 
                             Width="174px"/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image5" runat="server" ImageUrl="images/lhp6.JPG" Height="151px" 

                             Width="174px"/>
                             <br />
                             <br />
                         <br />
                             <asp:Image ID="Image6" runat="server" ImageUrl="images/lhp7.jpeg" Height="151px" 
                             Width="174px"/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Image ID="Image7" runat="server" ImageUrl="images/lhp.JPG" Height="151px" 
                             Width="174px"/>
                     </asp:Panel>
                 </td>
             </tr>
